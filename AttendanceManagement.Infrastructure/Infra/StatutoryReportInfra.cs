    ...
    public class StatutoryReportInfra : IStatutoryReportInfra
    {
        ...
        public async Task<object> GenerateStatutoryReport(StatutoryReportRequest request)
        {
            ...
            var summaries = reportList.Select(report => new StatutoryReportResponse
            {
                ...
                SumOfPresent = report.SumOfPresent,
                NoOfDaysAbsent = report.NoOfDaysAbsent,
                SumOfCl = report.SumOfCl,
                SumOfSl = report.SumOfSl,
                SumOfPl = report.SumOfPl,
                SumOfNcl = report.SumOfNcl,
                SumOfMgl = report.SumOfMgl,
            ...
            var reports = (from staff in staffDetailsList
                           ...
                           select new StatutoryReportDto
                           {
                               ...
                               SumOfPresent = summary.SumOfPresent,
                               NoOfDaysAbsent = summary.NoOfDaysAbsent,
                               SumOfCl = summary.SumOfCl,
                               SumOfSl = summary.SumOfSl,
                               SumOfPl = summary.SumOfPl,
                               SumOfNcl = summary.SumOfNcl,
                               SumOfMgl = summary.SumOfMgl,
