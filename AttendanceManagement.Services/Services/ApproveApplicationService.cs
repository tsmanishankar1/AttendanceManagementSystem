...
{
    public class ApproveApplicationService : IApproveApplication
    {
        private readonly AttendanceManagementSystemContext _context;
        private readonly IConfiguration _configuration;
        private readonly IEmailService _emailService;
        public ApproveApplicationService(AttendanceManagementSystemContext context, IConfiguration configuration, IEmailService emailService)
        {
            _context = context;
