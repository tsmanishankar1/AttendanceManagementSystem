...
namespace AttendanceManagement.Services
{
    public class ProbationService : IProbationService
    {
        ...
        public ProbationService(AttendanceManagementSystemContext context, IEmailService emailService, IWebHostEnvironment env, ILetterGeneration letterGenerationService)
        {
            _context = context;
