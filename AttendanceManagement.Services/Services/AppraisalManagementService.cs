...
{
    public class AppraisalManagementService : IAppraisalManagement
    {
        private readonly AttendanceManagementSystemContext _context;
        private readonly IEmailService _emailService;
        private readonly string _workspacePath;
        private readonly ILetterGeneration _letterGenerationService;
        public AppraisalManagementService(AttendanceManagementSystemContext context, IEmailService emailService, IWebHostEnvironment env, ILetterGeneration letterGenerationService)
        {
            _context = context;
