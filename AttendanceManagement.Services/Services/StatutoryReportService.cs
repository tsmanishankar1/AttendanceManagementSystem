...
{
    public class StatutoryReportService : IStatutoryReport
    {
        private readonly AttendanceManagementSystemContext _context;
        private readonly StoredProcedureDbContext _storedProcedureDbContext;
        public StatutoryReportService(AttendanceManagementSystemContext context, StoredProcedureDbContext storedProcedureDbContext)
        {
            _context = context;
