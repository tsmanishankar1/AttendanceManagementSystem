...
public partial class SmxCardHolder
{
    ...
    public string? ChFinger1Identity { get; set; }

    public string? ChFinger2Identity { get; set; }
    ...
    public virtual SmxBranch? ChBr { get; set; }

    public virtual SmxCompany? ChCg { get; set; }

    public virtual SmxCardStatus? ChCs { get; set; }

    public virtual SmxCategory? ChCt { get; set; }

    public virtual SmxDesignation? ChDn { get; set; }

    public virtual SmxDepartment? ChDp { get; set; }

    public virtual SmxEmployeeStatus? ChEs { get; set; }

    public virtual SmxLocation? ChLn { get; set; }

    public virtual SmxMessage? ChMs { get; set; }

    public virtual SmxUnit? ChUt { get; set; }
}
