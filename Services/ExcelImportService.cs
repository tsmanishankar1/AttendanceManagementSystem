            ...
            using (var stream = new MemoryStream())
            {
                ...
                using (var package = new ExcelPackage(stream))
                {
                    ...
                    else if (excelImportId == 8)
                    {
                        ...
                        {
                            Console.WriteLine($"Inserting {manualPunchRequisitions.Count} records into the database...");
                    ...
                    else if (excelImportId == 16)
                    {
                        ...
                        {
                            Console.WriteLine($"Inserting {shiftExtensions.Count} records into the database...");
                    ...
                    else if (excelImportId == 17)
                    {
                        ...
                        {
                            Console.WriteLine($"Inserting {staffVaccinations.Count} records into the database...");
