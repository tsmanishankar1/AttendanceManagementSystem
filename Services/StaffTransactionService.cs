...
namespace AttendanceManagement.Services
{
    public class StaffTransactionService
    {
        ...
        public StaffTransactionService(AttendanceManagementSystemContext context)
        {
            _context = context;
        }
        ...
        public async Task<List<AcademicDetailResponse>> GetByStaffIdAsync(int staffId)
        {
            ...
            return academicDetails.Select(academicDetail => new AcademicDetailResponse
            {
        ...
        {
            if (academicDetailsRequests == null || academicDetailsRequests.AcademicDetails == null || !academicDetailsRequests.AcademicDetails.Any())
                return "No academic details provided for update.";
        ...
        public async Task<string> DeleteAcademicDetailAsync(int academicDetailId, int deletedBy)
        {
            ...
            var academicDetail = await _context.AcademicDetails
                .FirstOrDefaultAsync(a => a.Id == academicDetailId && a.IsActive == true);
        ...
        public async Task<List<CertificationCourseResponse>> GetByCerticateStaffIdAsync(int staffId)
        {
            ...
            return certificationCourses.Select(certificationCourse => new CertificationCourseResponse
            {
        ...
        {
            if (certificationCourseRequests == null || certificationCourseRequests.CertificationCourses == null || !certificationCourseRequests.CertificationCourses.Any())
                return "No certification courses provided.";
        ...
        {
            if (certificationCourseRequests == null || certificationCourseRequests.CertificationCourses == null || !certificationCourseRequests.CertificationCourses.Any())
                return "No certification courses provided for update.";
        ...
        public async Task<string> DeleteCertificationCourseAsync(int certificationCourseId, int deletedBy)
        {
            ...
            var certificationCourse = await _context.CertificationCourses
                .FirstOrDefaultAsync(c => c.Id == certificationCourseId && c.IsActive == true);

            if (certificationCourse == null)
                return "Certification course not found";
        ...
        {
            if (previousEmploymentRequests == null || previousEmploymentRequests.PreviousEmployments == null || !previousEmploymentRequests.PreviousEmployments.Any())
                return "No previous employment records provided for creation.";
            ...
            foreach (var request in previousEmploymentRequests.PreviousEmployments)
            {
                var previousEmployment = new PreviousEmployment
                {
                    ...
                    CreatedBy = previousEmploymentRequests.CreatedBy, // CreatedBy from wrapper
                    CreatedUtc = DateTime.UtcNow,
                    IsActive = true
                };
        ...
        {
            if (previousEmploymentUpdateRequest == null ||
                previousEmploymentUpdateRequest.PreviousEmployments == null ||
                !previousEmploymentUpdateRequest.PreviousEmployments.Any())
            {
                return "No previous employment records provided for update.";
            }
        ...
        public async Task<string> DeleteAsync(int previousEmploymentId, int deletedBy)
        {
            ...
            if (previousEmployment == null)
                return "Previous employment record not found";
