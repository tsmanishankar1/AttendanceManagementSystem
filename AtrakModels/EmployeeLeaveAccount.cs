...
public partial class EmployeeLeaveAccount
{
    ...
    public virtual LeaveCreditDebitReason LeaveCreditDebitReason { get; set; } = null!;

    public virtual LeaveType? LeaveType { get; set; }

    public virtual Staff? Staff { get; set; }

    public virtual LeaveTransactionType TransactionFlagNavigation { get; set; } = null!;
}
